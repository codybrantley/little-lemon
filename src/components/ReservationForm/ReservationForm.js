        ...
        <div className="container">
            <form id="form" className="reservation__form" onSubmit={handleSubmit}>
                <div className="reservation__input_container">
                    ...
                    <input className="reservation__input" id="date" aria-required="true" type="date" min={todaysDate} {...getFieldProps("date")} aria-invalid="false" {...errors.date && {'aria-describedby': 'date-error', 'aria-invalid': 'true', 'className': 'reservation__invalid'}} />
                ...
                <div className="reservation__input_container">
                    ...
                    <select className="reservation__input" id="time" aria-required="true" {...getFieldProps("time")} aria-invalid="false" {...errors.time && {'aria-describedby': 'time-error', 'aria-invalid': 'true'}}>
                ...
                <div className="reservation__input_container">
                    ...
                    <input className="reservation__input" type="number" aria-required="true" placeholder="1" min="1" max="10" id="guests" {...getFieldProps("guests")} aria-invalid="false" {...errors.guests && {'aria-describedby': 'guests-error', 'aria-invalid': 'true', 'className': 'reservation__invalid'}} />
                ...
                <div className="reservation__input_container">
                    ...
                    <textarea className="reservation__input" id="tablePreferences" rows="4" aria-required="false" {...getFieldProps("tablePreferences")} aria-invalid="false" placeholder="By the window, close the bathroom, ect."></textarea>
                </div>
                <div className="reservation__input_container">
                    <label className="reservation__label" htmlFor="name">Your name *</label>
                    <input className="reservation__input" id="name" aria-required="true" type="text" {...getFieldProps("name")} aria-invalid="false" {...errors.name && {'aria-describedby': 'name-error', 'aria-invalid': 'true', 'className': 'reservation__invalid'}} />
                ...
                <div className="reservation__input_container">
                    ...
                    <input className="reservation__input" id="emailAddress" aria-required="true" type="email" {...getFieldProps("emailAddress")} aria-invalid="false" {...errors.emailAddress && {'aria-describedby': 'email-error', 'aria-invalid': 'true', 'className': 'reservation__invalid'}} />
